...
class CustomPostScheduler:
                    ...
                    if post['status'] == 'scheduled':
                        ...
                        if post_time > current_time:
                            self.scheduler.add_job(
                                ...
                                args=[post['topic'], post['content'], post.get('with_image')],
                                id=post['id'],
    ...
    def add_post(self, topic, schedule_time, content=None, with_image=None):
        """
        ...
        Args:
            ...
            with_image (bool, optional): Override configured image generation setting
        """
        try:
    ...
    def execute_scheduled_post(self, topic, content=None, with_image=None):
        ...
        try:
            ...
            if not content:
                ...
                content_data = self.content_generator.generate_post(topic, with_image)
                if not content_data:
